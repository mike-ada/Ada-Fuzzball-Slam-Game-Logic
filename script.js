...
function setup() {
	...
	ground = new c_ground(VP_WIDTH/2, VP_HEIGHT-10, VP_WIDTH, 20, "ground"); //create a ground object using the ground class
	...
	special = new c_special(800, 200, CRATE_WIDTH, CRATE_HEIGHT, "special");
